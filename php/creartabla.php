...
<?php
    ...
    if (!$conn) {
        ...
        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        <strong>Conexión Exitosa!</strong> La base de datos fue conectada.
        </div>';
    }
    //Script SQL para crear tabla.
    $sql = "CREATE TABLE tabla31(
    ...
    if ($conn->query($sql) == TRUE) {
        echo '<div class="alert alert-success alert-dismissible fade show">
        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        <strong>Creación Exitosa!</strong> Tabla: --<strong> Tabla31</strong> -- creada con éxito.
        </div>';
} else{
    echo '<div class="alert alert-danger alert-dismissible fade show">
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    <strong>Error Creando Tabla: !</strong> ' . mysqli_error($conn). '</div>';
}
